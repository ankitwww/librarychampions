    ...
    <>
      <Center as="section">
        ...
        >
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Library Champions (unofficial).
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Library Champions
                (unofficial), accessible from{" "}
                <a
                  href="https://librarychampions.ankitwww.com/"
                  rel="external nofollow noopener noreferrer"
                  target="_blank"
                >
                  https://librarychampions.ankitwww.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: hi@ankitwww.com</li>
          </ul>
        </Box>
      </Center>
    </>
